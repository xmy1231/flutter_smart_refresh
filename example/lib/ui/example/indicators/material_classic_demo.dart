...
class MaterialClassicDemo extends StatefulWidget {
  const MaterialClassicDemo({super.key});

  @override
  State<MaterialClassicDemo> createState() => _MaterialClassicDemoState();
}

class _MaterialClassicDemoState extends State<MaterialClassicDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(s.appBarMaterialClassicHeader)),
      body: SmartRefresher(
        enablePullDown: true,
        enablePullUp: true,

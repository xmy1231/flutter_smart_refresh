...
class WaterDropMaterialDemo extends StatefulWidget {
  const WaterDropMaterialDemo({super.key});

  @override
  State<WaterDropMaterialDemo> createState() => _WaterDropMaterialDemoState();
}

class _WaterDropMaterialDemoState extends State<WaterDropMaterialDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(s.appBarWaterDropMaterialHeader)),
      body: SmartRefresher(
        enablePullDown: true,
        enablePullUp: true,

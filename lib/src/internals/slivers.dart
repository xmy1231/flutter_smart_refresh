...
class RenderSliverRefresh extends RenderSliverSingleBoxAdapter {
  ...
  void paint(PaintingContext paintContext, Offset offset) {
    paintContext.paintChild(
      child!,
      Offset(offset.dx, offset.dy + (paintOffsetY ?? 0.0)),
    );
  }
...
class RenderSliverRefreshBody extends RenderSliverSingleBoxAdapter {
  ...
  static const double _maxExtent = 1111111.0;
  ...
  void performLayout() {
    ...
    child!.layout(
      constraints.asBoxConstraints(maxExtent: _maxExtent),
      parentUsesSize: true,
    );
    double? childExtent;
